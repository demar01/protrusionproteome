...
description: >
  Step-by-step of proteomic analysis of cell bodies and protrusions.
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to protrusions proteome analysis}
...
shotgunmass spectrometry-based proteomics experiments with tandem mass tag (TMT) 
...
[@Dermit2020] (PRIDE PXD021239).

The raw mass spectrometry data were first analyzed using MaxQuant [@Cox2014]. We 
initially perform a number of data cuality checks including trypsin efficiency and 
TMT labeling incorporation. 

## QC: Calculating protease efficiency 
...
efficiency. This information is contained in the "peptides.txt" file, and is
...
## QC: Calculating TMT labeling efficiency 

TMT label efficiency can be measured as a proxy of peptides modified by TMT. This information is contained in the "evidence.txt" file, and is
provided with this package:
...
To visualize TMT label efficiency, the plot_labelingefficiency function can be used.
```{r plot-labelingefficiency}
 plot_labelingefficiency(evidencedata)
```

## Getting aggregated protein data

Protein intensities are obtained from aggregated peptides over protein groups. This
information is contained in the “proteinGroups.txt” file, is provided with this
...
We filter for decoy database hits, contaminant proteins and  hits only identified by site, which are indicated by "+" in the columns "Reverse","Potential.contaminants" and "Only.identified.by.site", respectively.
...
# Understanding which columns will be used in the SummarizedExperiment object
...
## Making a SummarizedExperiment object from TMT data
